...
//                     judul = nameGenderHost[0],
//                     jenisBarang = nameGenderHost[1],
//                     deskripsi = nameGenderHost[0] + '.' + nameGenderHost[1] + '@' + nameGenderHost[3],
//                     idPemilik = nameGenderHost[0],
//                     bukaLelang = cityState[0],
//                     tutupLelang = state
//                 };
